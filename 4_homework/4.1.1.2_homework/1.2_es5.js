...
Post.prototype.edit = function (text) { //метод edit, который будет 
    // принимать текст и записывать его в свойство text объекта
    this.text = text;
}
...
function AttachedPost(author, text, date) {
    ...
    this.highlighted = false;//свойство highlighted со значением false
}
AttachedPost.prototype = Object.create(Post.prototype);//создание прослойки create, что бы прототипы не указывали на одну область памяти 
AttachedPost.prototype.constructor = AttachedPost;//из за строки выше утерян конструктор, прописываем его вручную

AttachedPost.prototype.makeTextHighlighted = function () {
    this.highlighted = true;//свойство highlighted со значением true
}
